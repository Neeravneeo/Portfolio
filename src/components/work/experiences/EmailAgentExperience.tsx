        ...
        {caseStudyPerspective === 'designer' ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl glass-panel border border-white/10 space-y-3">
              <span className="text-xs font-mono text-emerald-400">HUMAN-IN-THE-LOOP SAFETY</span>
            ...
            <div className="p-6 rounded-2xl glass-panel border border-white/10 space-y-3">
              <span className="text-xs font-mono text-emerald-400">CONFIDENCE THRESHOLD UX</span>
              ...
              <div className="p-3 rounded-xl bg-emerald-950/40 border border-emerald-500/20 text-xs font-mono text-emerald-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl glass-panel border border-emerald-500/20 space-y-3">
              <span className="text-xs font-mono text-emerald-400">N8N ORCHESTRATION & RAG</span>
            ...
            <div className="p-6 rounded-2xl glass-panel border border-emerald-500/20 space-y-3">
              <span className="text-xs font-mono text-emerald-400">GUARDRAILS & LATENCY GAINS</span>
              <ul className="space-y-2 text-xs text-slate-300">
